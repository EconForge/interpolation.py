...
def eval_cubic_spline_1(smin, smax, orders, coefs, point, val):
    ...
    val = Phi0_0*(coefs[k,i0+0]) + Phi0_1*(coefs[k,i0+1]) + Phi0_2*(coefs[k,i0+2]) + Phi0_3*(coefs[k,i0+3])
...
def eval_cubic_spline_2(smin, smax, orders, coefs, point, val):
    ...
    val = Phi0_0*(Phi1_0*(coefs[k,i0+0,i1+0]) + Phi1_1*(coefs[k,i0+0,i1+1]) + Phi1_2*(coefs[k,i0+0,i1+2]) + Phi1_3*(coefs[k,i0+0,i1+3])) + Phi0_1*(Phi1_0*(coefs[k,i0+1,i1+0]) + Phi1_1*(coefs[k,i0+1,i1+1]) + Phi1_2*(coefs[k,i0+1,i1+2]) + Phi1_3*(coefs[k,i0+1,i1+3])) + Phi0_2*(Phi1_0*(coefs[k,i0+2,i1+0]) + Phi1_1*(coefs[k,i0+2,i1+1]) + Phi1_2*(coefs[k,i0+2,i1+2]) + Phi1_3*(coefs[k,i0+2,i1+3])) + Phi0_3*(Phi1_0*(coefs[k,i0+3,i1+0]) + Phi1_1*(coefs[k,i0+3,i1+1]) + Phi1_2*(coefs[k,i0+3,i1+2]) + Phi1_3*(coefs[k,i0+3,i1+3]))
...
def eval_cubic_spline_3(smin, smax, orders, coefs, point, val):
    ...
    val = Phi0_0*(Phi1_0*(Phi2_0*(coefs[k,i0+0,i1+0,i2+0]) + Phi2_1*(coefs[k,i0+0,i1+0,i2+1]) + Phi2_2*(coefs[k,i0+0,i1+0,i2+2]) + Phi2_3*(coefs[k,i0+0,i1+0,i2+3])) + Phi1_1*(Phi2_0*(coefs[k,i0+0,i1+1,i2+0]) + Phi2_1*(coefs[k,i0+0,i1+1,i2+1]) + Phi2_2*(coefs[k,i0+0,i1+1,i2+2]) + Phi2_3*(coefs[k,i0+0,i1+1,i2+3])) + Phi1_2*(Phi2_0*(coefs[k,i0+0,i1+2,i2+0]) + Phi2_1*(coefs[k,i0+0,i1+2,i2+1]) + Phi2_2*(coefs[k,i0+0,i1+2,i2+2]) + Phi2_3*(coefs[k,i0+0,i1+2,i2+3])) + Phi1_3*(Phi2_0*(coefs[k,i0+0,i1+3,i2+0]) + Phi2_1*(coefs[k,i0+0,i1+3,i2+1]) + Phi2_2*(coefs[k,i0+0,i1+3,i2+2]) + Phi2_3*(coefs[k,i0+0,i1+3,i2+3]))) + Phi0_1*(Phi1_0*(Phi2_0*(coefs[k,i0+1,i1+0,i2+0]) + Phi2_1*(coefs[k,i0+1,i1+0,i2+1]) + Phi2_2*(coefs[k,i0+1,i1+0,i2+2]) + Phi2_3*(coefs[k,i0+1,i1+0,i2+3])) + Phi1_1*(Phi2_0*(coefs[k,i0+1,i1+1,i2+0]) + Phi2_1*(coefs[k,i0+1,i1+1,i2+1]) + Phi2_2*(coefs[k,i0+1,i1+1,i2+2]) + Phi2_3*(coefs[k,i0+1,i1+1,i2+3])) + Phi1_2*(Phi2_0*(coefs[k,i0+1,i1+2,i2+0]) + Phi2_1*(coefs[k,i0+1,i1+2,i2+1]) + Phi2_2*(coefs[k,i0+1,i1+2,i2+2]) + Phi2_3*(coefs[k,i0+1,i1+2,i2+3])) + Phi1_3*(Phi2_0*(coefs[k,i0+1,i1+3,i2+0]) + Phi2_1*(coefs[k,i0+1,i1+3,i2+1]) + Phi2_2*(coefs[k,i0+1,i1+3,i2+2]) + Phi2_3*(coefs[k,i0+1,i1+3,i2+3]))) + Phi0_2*(Phi1_0*(Phi2_0*(coefs[k,i0+2,i1+0,i2+0]) + Phi2_1*(coefs[k,i0+2,i1+0,i2+1]) + Phi2_2*(coefs[k,i0+2,i1+0,i2+2]) + Phi2_3*(coefs[k,i0+2,i1+0,i2+3])) + Phi1_1*(Phi2_0*(coefs[k,i0+2,i1+1,i2+0]) + Phi2_1*(coefs[k,i0+2,i1+1,i2+1]) + Phi2_2*(coefs[k,i0+2,i1+1,i2+2]) + Phi2_3*(coefs[k,i0+2,i1+1,i2+3])) + Phi1_2*(Phi2_0*(coefs[k,i0+2,i1+2,i2+0]) + Phi2_1*(coefs[k,i0+2,i1+2,i2+1]) + Phi2_2*(coefs[k,i0+2,i1+2,i2+2]) + Phi2_3*(coefs[k,i0+2,i1+2,i2+3])) + Phi1_3*(Phi2_0*(coefs[k,i0+2,i1+3,i2+0]) + Phi2_1*(coefs[k,i0+2,i1+3,i2+1]) + Phi2_2*(coefs[k,i0+2,i1+3,i2+2]) + Phi2_3*(coefs[k,i0+2,i1+3,i2+3]))) + Phi0_3*(Phi1_0*(Phi2_0*(coefs[k,i0+3,i1+0,i2+0]) + Phi2_1*(coefs[k,i0+3,i1+0,i2+1]) + Phi2_2*(coefs[k,i0+3,i1+0,i2+2]) + Phi2_3*(coefs[k,i0+3,i1+0,i2+3])) + Phi1_1*(Phi2_0*(coefs[k,i0+3,i1+1,i2+0]) + Phi2_1*(coefs[k,i0+3,i1+1,i2+1]) + Phi2_2*(coefs[k,i0+3,i1+1,i2+2]) + Phi2_3*(coefs[k,i0+3,i1+1,i2+3])) + Phi1_2*(Phi2_0*(coefs[k,i0+3,i1+2,i2+0]) + Phi2_1*(coefs[k,i0+3,i1+2,i2+1]) + Phi2_2*(coefs[k,i0+3,i1+2,i2+2]) + Phi2_3*(coefs[k,i0+3,i1+2,i2+3])) + Phi1_3*(Phi2_0*(coefs[k,i0+3,i1+3,i2+0]) + Phi2_1*(coefs[k,i0+3,i1+3,i2+1]) + Phi2_2*(coefs[k,i0+3,i1+3,i2+2]) + Phi2_3*(coefs[k,i0+3,i1+3,i2+3])))
...
def eval_cubic_spline_4(smin, smax, orders, coefs, point, val):
    ...
    val = Phi0_0*(Phi1_0*(Phi2_0*(Phi3_0*(coefs[k,i0+0,i1+0,i2+0,i3+0]) + Phi3_1*(coefs[k,i0+0,i1+0,i2+0,i3+1]) + Phi3_2*(coefs[k,i0+0,i1+0,i2+0,i3+2]) + Phi3_3*(coefs[k,i0+0,i1+0,i2+0,i3+3])) + Phi2_1*(Phi3_0*(coefs[k,i0+0,i1+0,i2+1,i3+0]) + Phi3_1*(coefs[k,i0+0,i1+0,i2+1,i3+1]) + Phi3_2*(coefs[k,i0+0,i1+0,i2+1,i3+2]) + Phi3_3*(coefs[k,i0+0,i1+0,i2+1,i3+3])) + Phi2_2*(Phi3_0*(coefs[k,i0+0,i1+0,i2+2,i3+0]) + Phi3_1*(coefs[k,i0+0,i1+0,i2+2,i3+1]) + Phi3_2*(coefs[k,i0+0,i1+0,i2+2,i3+2]) + Phi3_3*(coefs[k,i0+0,i1+0,i2+2,i3+3])) + Phi2_3*(Phi3_0*(coefs[k,i0+0,i1+0,i2+3,i3+0]) + Phi3_1*(coefs[k,i0+0,i1+0,i2+3,i3+1]) + Phi3_2*(coefs[k,i0+0,i1+0,i2+3,i3+2]) + Phi3_3*(coefs[k,i0+0,i1+0,i2+3,i3+3]))) + Phi1_1*(Phi2_0*(Phi3_0*(coefs[k,i0+0,i1+1,i2+0,i3+0]) + Phi3_1*(coefs[k,i0+0,i1+1,i2+0,i3+1]) + Phi3_2*(coefs[k,i0+0,i1+1,i2+0,i3+2]) + Phi3_3*(coefs[k,i0+0,i1+1,i2+0,i3+3])) + Phi2_1*(Phi3_0*(coefs[k,i0+0,i1+1,i2+1,i3+0]) + Phi3_1*(coefs[k,i0+0,i1+1,i2+1,i3+1]) + Phi3_2*(coefs[k,i0+0,i1+1,i2+1,i3+2]) + Phi3_3*(coefs[k,i0+0,i1+1,i2+1,i3+3])) + Phi2_2*(Phi3_0*(coefs[k,i0+0,i1+1,i2+2,i3+0]) + Phi3_1*(coefs[k,i0+0,i1+1,i2+2,i3+1]) + Phi3_2*(coefs[k,i0+0,i1+1,i2+2,i3+2]) + Phi3_3*(coefs[k,i0+0,i1+1,i2+2,i3+3])) + Phi2_3*(Phi3_0*(coefs[k,i0+0,i1+1,i2+3,i3+0]) + Phi3_1*(coefs[k,i0+0,i1+1,i2+3,i3+1]) + Phi3_2*(coefs[k,i0+0,i1+1,i2+3,i3+2]) + Phi3_3*(coefs[k,i0+0,i1+1,i2+3,i3+3]))) + Phi1_2*(Phi2_0*(Phi3_0*(coefs[k,i0+0,i1+2,i2+0,i3+0]) + Phi3_1*(coefs[k,i0+0,i1+2,i2+0,i3+1]) + Phi3_2*(coefs[k,i0+0,i1+2,i2+0,i3+2]) + Phi3_3*(coefs[k,i0+0,i1+2,i2+0,i3+3])) + Phi2_1*(Phi3_0*(coefs[k,i0+0,i1+2,i2+1,i3+0]) + Phi3_1*(coefs[k,i0+0,i1+2,i2+1,i3+1]) + Phi3_2*(coefs[k,i0+0,i1+2,i2+1,i3+2]) + Phi3_3*(coefs[k,i0+0,i1+2,i2+1,i3+3])) + Phi2_2*(Phi3_0*(coefs[k,i0+0,i1+2,i2+2,i3+0]) + Phi3_1*(coefs[k,i0+0,i1+2,i2+2,i3+1]) + Phi3_2*(coefs[k,i0+0,i1+2,i2+2,i3+2]) + Phi3_3*(coefs[k,i0+0,i1+2,i2+2,i3+3])) + Phi2_3*(Phi3_0*(coefs[k,i0+0,i1+2,i2+3,i3+0]) + Phi3_1*(coefs[k,i0+0,i1+2,i2+3,i3+1]) + Phi3_2*(coefs[k,i0+0,i1+2,i2+3,i3+2]) + Phi3_3*(coefs[k,i0+0,i1+2,i2+3,i3+3]))) + Phi1_3*(Phi2_0*(Phi3_0*(coefs[k,i0+0,i1+3,i2+0,i3+0]) + Phi3_1*(coefs[k,i0+0,i1+3,i2+0,i3+1]) + Phi3_2*(coefs[k,i0+0,i1+3,i2+0,i3+2]) + Phi3_3*(coefs[k,i0+0,i1+3,i2+0,i3+3])) + Phi2_1*(Phi3_0*(coefs[k,i0+0,i1+3,i2+1,i3+0]) + Phi3_1*(coefs[k,i0+0,i1+3,i2+1,i3+1]) + Phi3_2*(coefs[k,i0+0,i1+3,i2+1,i3+2]) + Phi3_3*(coefs[k,i0+0,i1+3,i2+1,i3+3])) + Phi2_2*(Phi3_0*(coefs[k,i0+0,i1+3,i2+2,i3+0]) + Phi3_1*(coefs[k,i0+0,i1+3,i2+2,i3+1]) + Phi3_2*(coefs[k,i0+0,i1+3,i2+2,i3+2]) + Phi3_3*(coefs[k,i0+0,i1+3,i2+2,i3+3])) + Phi2_3*(Phi3_0*(coefs[k,i0+0,i1+3,i2+3,i3+0]) + Phi3_1*(coefs[k,i0+0,i1+3,i2+3,i3+1]) + Phi3_2*(coefs[k,i0+0,i1+3,i2+3,i3+2]) + Phi3_3*(coefs[k,i0+0,i1+3,i2+3,i3+3])))) + Phi0_1*(Phi1_0*(Phi2_0*(Phi3_0*(coefs[k,i0+1,i1+0,i2+0,i3+0]) + Phi3_1*(coefs[k,i0+1,i1+0,i2+0,i3+1]) + Phi3_2*(coefs[k,i0+1,i1+0,i2+0,i3+2]) + Phi3_3*(coefs[k,i0+1,i1+0,i2+0,i3+3])) + Phi2_1*(Phi3_0*(coefs[k,i0+1,i1+0,i2+1,i3+0]) + Phi3_1*(coefs[k,i0+1,i1+0,i2+1,i3+1]) + Phi3_2*(coefs[k,i0+1,i1+0,i2+1,i3+2]) + Phi3_3*(coefs[k,i0+1,i1+0,i2+1,i3+3])) + Phi2_2*(Phi3_0*(coefs[k,i0+1,i1+0,i2+2,i3+0]) + Phi3_1*(coefs[k,i0+1,i1+0,i2+2,i3+1]) + Phi3_2*(coefs[k,i0+1,i1+0,i2+2,i3+2]) + Phi3_3*(coefs[k,i0+1,i1+0,i2+2,i3+3])) + Phi2_3*(Phi3_0*(coefs[k,i0+1,i1+0,i2+3,i3+0]) + Phi3_1*(coefs[k,i0+1,i1+0,i2+3,i3+1]) + Phi3_2*(coefs[k,i0+1,i1+0,i2+3,i3+2]) + Phi3_3*(coefs[k,i0+1,i1+0,i2+3,i3+3]))) + Phi1_1*(Phi2_0*(Phi3_0*(coefs[k,i0+1,i1+1,i2+0,i3+0]) + Phi3_1*(coefs[k,i0+1,i1+1,i2+0,i3+1]) + Phi3_2*(coefs[k,i0+1,i1+1,i2+0,i3+2]) + Phi3_3*(coefs[k,i0+1,i1+1,i2+0,i3+3])) + Phi2_1*(Phi3_0*(coefs[k,i0+1,i1+1,i2+1,i3+0]) + Phi3_1*(coefs[k,i0+1,i1+1,i2+1,i3+1]) + Phi3_2*(coefs[k,i0+1,i1+1,i2+1,i3+2]) + Phi3_3*(coefs[k,i0+1,i1+1,i2+1,i3+3])) + Phi2_2*(Phi3_0*(coefs[k,i0+1,i1+1,i2+2,i3+0]) + Phi3_1*(coefs[k,i0+1,i1+1,i2+2,i3+1]) + Phi3_2*(coefs[k,i0+1,i1+1,i2+2,i3+2]) + Phi3_3*(coefs[k,i0+1,i1+1,i2+2,i3+3])) + Phi2_3*(Phi3_0*(coefs[k,i0+1,i1+1,i2+3,i3+0]) + Phi3_1*(coefs[k,i0+1,i1+1,i2+3,i3+1]) + Phi3_2*(coefs[k,i0+1,i1+1,i2+3,i3+2]) + Phi3_3*(coefs[k,i0+1,i1+1,i2+3,i3+3]))) + Phi1_2*(Phi2_0*(Phi3_0*(coefs[k,i0+1,i1+2,i2+0,i3+0]) + Phi3_1*(coefs[k,i0+1,i1+2,i2+0,i3+1]) + Phi3_2*(coefs[k,i0+1,i1+2,i2+0,i3+2]) + Phi3_3*(coefs[k,i0+1,i1+2,i2+0,i3+3])) + Phi2_1*(Phi3_0*(coefs[k,i0+1,i1+2,i2+1,i3+0]) + Phi3_1*(coefs[k,i0+1,i1+2,i2+1,i3+1]) + Phi3_2*(coefs[k,i0+1,i1+2,i2+1,i3+2]) + Phi3_3*(coefs[k,i0+1,i1+2,i2+1,i3+3])) + Phi2_2*(Phi3_0*(coefs[k,i0+1,i1+2,i2+2,i3+0]) + Phi3_1*(coefs[k,i0+1,i1+2,i2+2,i3+1]) + Phi3_2*(coefs[k,i0+1,i1+2,i2+2,i3+2]) + Phi3_3*(coefs[k,i0+1,i1+2,i2+2,i3+3])) + Phi2_3*(Phi3_0*(coefs[k,i0+1,i1+2,i2+3,i3+0]) + Phi3_1*(coefs[k,i0+1,i1+2,i2+3,i3+1]) + Phi3_2*(coefs[k,i0+1,i1+2,i2+3,i3+2]) + Phi3_3*(coefs[k,i0+1,i1+2,i2+3,i3+3]))) + Phi1_3*(Phi2_0*(Phi3_0*(coefs[k,i0+1,i1+3,i2+0,i3+0]) + Phi3_1*(coefs[k,i0+1,i1+3,i2+0,i3+1]) + Phi3_2*(coefs[k,i0+1,i1+3,i2+0,i3+2]) + Phi3_3*(coefs[k,i0+1,i1+3,i2+0,i3+3])) + Phi2_1*(Phi3_0*(coefs[k,i0+1,i1+3,i2+1,i3+0]) + Phi3_1*(coefs[k,i0+1,i1+3,i2+1,i3+1]) + Phi3_2*(coefs[k,i0+1,i1+3,i2+1,i3+2]) + Phi3_3*(coefs[k,i0+1,i1+3,i2+1,i3+3])) + Phi2_2*(Phi3_0*(coefs[k,i0+1,i1+3,i2+2,i3+0]) + Phi3_1*(coefs[k,i0+1,i1+3,i2+2,i3+1]) + Phi3_2*(coefs[k,i0+1,i1+3,i2+2,i3+2]) + Phi3_3*(coefs[k,i0+1,i1+3,i2+2,i3+3])) + Phi2_3*(Phi3_0*(coefs[k,i0+1,i1+3,i2+3,i3+0]) + Phi3_1*(coefs[k,i0+1,i1+3,i2+3,i3+1]) + Phi3_2*(coefs[k,i0+1,i1+3,i2+3,i3+2]) + Phi3_3*(coefs[k,i0+1,i1+3,i2+3,i3+3])))) + Phi0_2*(Phi1_0*(Phi2_0*(Phi3_0*(coefs[k,i0+2,i1+0,i2+0,i3+0]) + Phi3_1*(coefs[k,i0+2,i1+0,i2+0,i3+1]) + Phi3_2*(coefs[k,i0+2,i1+0,i2+0,i3+2]) + Phi3_3*(coefs[k,i0+2,i1+0,i2+0,i3+3])) + Phi2_1*(Phi3_0*(coefs[k,i0+2,i1+0,i2+1,i3+0]) + Phi3_1*(coefs[k,i0+2,i1+0,i2+1,i3+1]) + Phi3_2*(coefs[k,i0+2,i1+0,i2+1,i3+2]) + Phi3_3*(coefs[k,i0+2,i1+0,i2+1,i3+3])) + Phi2_2*(Phi3_0*(coefs[k,i0+2,i1+0,i2+2,i3+0]) + Phi3_1*(coefs[k,i0+2,i1+0,i2+2,i3+1]) + Phi3_2*(coefs[k,i0+2,i1+0,i2+2,i3+2]) + Phi3_3*(coefs[k,i0+2,i1+0,i2+2,i3+3])) + Phi2_3*(Phi3_0*(coefs[k,i0+2,i1+0,i2+3,i3+0]) + Phi3_1*(coefs[k,i0+2,i1+0,i2+3,i3+1]) + Phi3_2*(coefs[k,i0+2,i1+0,i2+3,i3+2]) + Phi3_3*(coefs[k,i0+2,i1+0,i2+3,i3+3]))) + Phi1_1*(Phi2_0*(Phi3_0*(coefs[k,i0+2,i1+1,i2+0,i3+0]) + Phi3_1*(coefs[k,i0+2,i1+1,i2+0,i3+1]) + Phi3_2*(coefs[k,i0+2,i1+1,i2+0,i3+2]) + Phi3_3*(coefs[k,i0+2,i1+1,i2+0,i3+3])) + Phi2_1*(Phi3_0*(coefs[k,i0+2,i1+1,i2+1,i3+0]) + Phi3_1*(coefs[k,i0+2,i1+1,i2+1,i3+1]) + Phi3_2*(coefs[k,i0+2,i1+1,i2+1,i3+2]) + Phi3_3*(coefs[k,i0+2,i1+1,i2+1,i3+3])) + Phi2_2*(Phi3_0*(coefs[k,i0+2,i1+1,i2+2,i3+0]) + Phi3_1*(coefs[k,i0+2,i1+1,i2+2,i3+1]) + Phi3_2*(coefs[k,i0+2,i1+1,i2+2,i3+2]) + Phi3_3*(coefs[k,i0+2,i1+1,i2+2,i3+3])) + Phi2_3*(Phi3_0*(coefs[k,i0+2,i1+1,i2+3,i3+0]) + Phi3_1*(coefs[k,i0+2,i1+1,i2+3,i3+1]) + Phi3_2*(coefs[k,i0+2,i1+1,i2+3,i3+2]) + Phi3_3*(coefs[k,i0+2,i1+1,i2+3,i3+3]))) + Phi1_2*(Phi2_0*(Phi3_0*(coefs[k,i0+2,i1+2,i2+0,i3+0]) + Phi3_1*(coefs[k,i0+2,i1+2,i2+0,i3+1]) + Phi3_2*(coefs[k,i0+2,i1+2,i2+0,i3+2]) + Phi3_3*(coefs[k,i0+2,i1+2,i2+0,i3+3])) + Phi2_1*(Phi3_0*(coefs[k,i0+2,i1+2,i2+1,i3+0]) + Phi3_1*(coefs[k,i0+2,i1+2,i2+1,i3+1]) + Phi3_2*(coefs[k,i0+2,i1+2,i2+1,i3+2]) + Phi3_3*(coefs[k,i0+2,i1+2,i2+1,i3+3])) + Phi2_2*(Phi3_0*(coefs[k,i0+2,i1+2,i2+2,i3+0]) + Phi3_1*(coefs[k,i0+2,i1+2,i2+2,i3+1]) + Phi3_2*(coefs[k,i0+2,i1+2,i2+2,i3+2]) + Phi3_3*(coefs[k,i0+2,i1+2,i2+2,i3+3])) + Phi2_3*(Phi3_0*(coefs[k,i0+2,i1+2,i2+3,i3+0]) + Phi3_1*(coefs[k,i0+2,i1+2,i2+3,i3+1]) + Phi3_2*(coefs[k,i0+2,i1+2,i2+3,i3+2]) + Phi3_3*(coefs[k,i0+2,i1+2,i2+3,i3+3]))) + Phi1_3*(Phi2_0*(Phi3_0*(coefs[k,i0+2,i1+3,i2+0,i3+0]) + Phi3_1*(coefs[k,i0+2,i1+3,i2+0,i3+1]) + Phi3_2*(coefs[k,i0+2,i1+3,i2+0,i3+2]) + Phi3_3*(coefs[k,i0+2,i1+3,i2+0,i3+3])) + Phi2_1*(Phi3_0*(coefs[k,i0+2,i1+3,i2+1,i3+0]) + Phi3_1*(coefs[k,i0+2,i1+3,i2+1,i3+1]) + Phi3_2*(coefs[k,i0+2,i1+3,i2+1,i3+2]) + Phi3_3*(coefs[k,i0+2,i1+3,i2+1,i3+3])) + Phi2_2*(Phi3_0*(coefs[k,i0+2,i1+3,i2+2,i3+0]) + Phi3_1*(coefs[k,i0+2,i1+3,i2+2,i3+1]) + Phi3_2*(coefs[k,i0+2,i1+3,i2+2,i3+2]) + Phi3_3*(coefs[k,i0+2,i1+3,i2+2,i3+3])) + Phi2_3*(Phi3_0*(coefs[k,i0+2,i1+3,i2+3,i3+0]) + Phi3_1*(coefs[k,i0+2,i1+3,i2+3,i3+1]) + Phi3_2*(coefs[k,i0+2,i1+3,i2+3,i3+2]) + Phi3_3*(coefs[k,i0+2,i1+3,i2+3,i3+3])))) + Phi0_3*(Phi1_0*(Phi2_0*(Phi3_0*(coefs[k,i0+3,i1+0,i2+0,i3+0]) + Phi3_1*(coefs[k,i0+3,i1+0,i2+0,i3+1]) + Phi3_2*(coefs[k,i0+3,i1+0,i2+0,i3+2]) + Phi3_3*(coefs[k,i0+3,i1+0,i2+0,i3+3])) + Phi2_1*(Phi3_0*(coefs[k,i0+3,i1+0,i2+1,i3+0]) + Phi3_1*(coefs[k,i0+3,i1+0,i2+1,i3+1]) + Phi3_2*(coefs[k,i0+3,i1+0,i2+1,i3+2]) + Phi3_3*(coefs[k,i0+3,i1+0,i2+1,i3+3])) + Phi2_2*(Phi3_0*(coefs[k,i0+3,i1+0,i2+2,i3+0]) + Phi3_1*(coefs[k,i0+3,i1+0,i2+2,i3+1]) + Phi3_2*(coefs[k,i0+3,i1+0,i2+2,i3+2]) + Phi3_3*(coefs[k,i0+3,i1+0,i2+2,i3+3])) + Phi2_3*(Phi3_0*(coefs[k,i0+3,i1+0,i2+3,i3+0]) + Phi3_1*(coefs[k,i0+3,i1+0,i2+3,i3+1]) + Phi3_2*(coefs[k,i0+3,i1+0,i2+3,i3+2]) + Phi3_3*(coefs[k,i0+3,i1+0,i2+3,i3+3]))) + Phi1_1*(Phi2_0*(Phi3_0*(coefs[k,i0+3,i1+1,i2+0,i3+0]) + Phi3_1*(coefs[k,i0+3,i1+1,i2+0,i3+1]) + Phi3_2*(coefs[k,i0+3,i1+1,i2+0,i3+2]) + Phi3_3*(coefs[k,i0+3,i1+1,i2+0,i3+3])) + Phi2_1*(Phi3_0*(coefs[k,i0+3,i1+1,i2+1,i3+0]) + Phi3_1*(coefs[k,i0+3,i1+1,i2+1,i3+1]) + Phi3_2*(coefs[k,i0+3,i1+1,i2+1,i3+2]) + Phi3_3*(coefs[k,i0+3,i1+1,i2+1,i3+3])) + Phi2_2*(Phi3_0*(coefs[k,i0+3,i1+1,i2+2,i3+0]) + Phi3_1*(coefs[k,i0+3,i1+1,i2+2,i3+1]) + Phi3_2*(coefs[k,i0+3,i1+1,i2+2,i3+2]) + Phi3_3*(coefs[k,i0+3,i1+1,i2+2,i3+3])) + Phi2_3*(Phi3_0*(coefs[k,i0+3,i1+1,i2+3,i3+0]) + Phi3_1*(coefs[k,i0+3,i1+1,i2+3,i3+1]) + Phi3_2*(coefs[k,i0+3,i1+1,i2+3,i3+2]) + Phi3_3*(coefs[k,i0+3,i1+1,i2+3,i3+3]))) + Phi1_2*(Phi2_0*(Phi3_0*(coefs[k,i0+3,i1+2,i2+0,i3+0]) + Phi3_1*(coefs[k,i0+3,i1+2,i2+0,i3+1]) + Phi3_2*(coefs[k,i0+3,i1+2,i2+0,i3+2]) + Phi3_3*(coefs[k,i0+3,i1+2,i2+0,i3+3])) + Phi2_1*(Phi3_0*(coefs[k,i0+3,i1+2,i2+1,i3+0]) + Phi3_1*(coefs[k,i0+3,i1+2,i2+1,i3+1]) + Phi3_2*(coefs[k,i0+3,i1+2,i2+1,i3+2]) + Phi3_3*(coefs[k,i0+3,i1+2,i2+1,i3+3])) + Phi2_2*(Phi3_0*(coefs[k,i0+3,i1+2,i2+2,i3+0]) + Phi3_1*(coefs[k,i0+3,i1+2,i2+2,i3+1]) + Phi3_2*(coefs[k,i0+3,i1+2,i2+2,i3+2]) + Phi3_3*(coefs[k,i0+3,i1+2,i2+2,i3+3])) + Phi2_3*(Phi3_0*(coefs[k,i0+3,i1+2,i2+3,i3+0]) + Phi3_1*(coefs[k,i0+3,i1+2,i2+3,i3+1]) + Phi3_2*(coefs[k,i0+3,i1+2,i2+3,i3+2]) + Phi3_3*(coefs[k,i0+3,i1+2,i2+3,i3+3]))) + Phi1_3*(Phi2_0*(Phi3_0*(coefs[k,i0+3,i1+3,i2+0,i3+0]) + Phi3_1*(coefs[k,i0+3,i1+3,i2+0,i3+1]) + Phi3_2*(coefs[k,i0+3,i1+3,i2+0,i3+2]) + Phi3_3*(coefs[k,i0+3,i1+3,i2+0,i3+3])) + Phi2_1*(Phi3_0*(coefs[k,i0+3,i1+3,i2+1,i3+0]) + Phi3_1*(coefs[k,i0+3,i1+3,i2+1,i3+1]) + Phi3_2*(coefs[k,i0+3,i1+3,i2+1,i3+2]) + Phi3_3*(coefs[k,i0+3,i1+3,i2+1,i3+3])) + Phi2_2*(Phi3_0*(coefs[k,i0+3,i1+3,i2+2,i3+0]) + Phi3_1*(coefs[k,i0+3,i1+3,i2+2,i3+1]) + Phi3_2*(coefs[k,i0+3,i1+3,i2+2,i3+2]) + Phi3_3*(coefs[k,i0+3,i1+3,i2+2,i3+3])) + Phi2_3*(Phi3_0*(coefs[k,i0+3,i1+3,i2+3,i3+0]) + Phi3_1*(coefs[k,i0+3,i1+3,i2+3,i3+1]) + Phi3_2*(coefs[k,i0+3,i1+3,i2+3,i3+2]) + Phi3_3*(coefs[k,i0+3,i1+3,i2+3,i3+3]))))
