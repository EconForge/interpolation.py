...
@njit
def eval_cubic_splines_1(smin, smax, orders, coefs, point, vals):
...
@njit
def eval_cubic_splines_2(smin, smax, orders, coefs, point, vals):
...
@njit
def eval_cubic_splines_3(smin, smax, orders, coefs, point, vals):
...
@njit
def eval_cubic_splines_4(smin, smax, orders, coefs, point, vals):
...
@njit
def vec_eval_cubic_splines_1(smin, smax, orders, coefs, points, vals):
...
@njit
def vec_eval_cubic_splines_2(smin, smax, orders, coefs, points, vals):
...
@njit
def vec_eval_cubic_splines_3(smin, smax, orders, coefs, points, vals):
...
@njit
def vec_eval_cubic_splines_4(smin, smax, orders, coefs, points, vals):
