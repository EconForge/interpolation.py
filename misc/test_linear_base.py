...
from interpolation.linear_bases.linear import UniformLinearSplineBasis, LinearSplineBasis
import numpy as np


uf = LinearSplineBasis(np.linspace(-0.5, 1.5, 10))
uf2 = UniformLinearSplineBasis(-0.5, 1.5, 10)
